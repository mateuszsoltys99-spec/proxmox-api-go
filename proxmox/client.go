...
func (c *Client) GetVmSpiceProxy(ctx context.Context, vmr *VmRef) (vmSpiceProxy map[string]interface{}, err error) {
	...
	_, _, err = c.session.postJSON(ctx, url, nil, nil, nil, &data)
	if err != nil {
		return nil, err
	}
	if data["data"] == nil {
...
func (c *Client) CreateTemplate(ctx context.Context, vmr *VmRef) error {
	...
	resp, _, err := c.session.post(ctx, url, nil, nil, nil)
	if err != nil {
		return err
	}
...
func (c *Client) Sendkey(ctx context.Context, vmr *VmRef, qmKey string) error {
	...
	_, _, err = c.session.put(ctx, url, nil, nil, &reqbody)
...
func (c *Client) DeleteVmParams(ctx context.Context, vmr *VmRef, params map[string]interface{}) (exitStatus string, err error) {
	...
	if vmr.haState != "" {
		...
		resp, _, err := c.session.delete(ctx, url, nil, nil)
		if err == nil {
			taskResponse, err := responseJSON(resp)
			if err != nil {
				return "", err
	...
	if len(values) != 0 {
		_, _, err = c.session.requestJSON(ctx, "DELETE", url, &values, nil, nil, &taskResponse)
	} else {
		_, _, err = c.session.requestJSON(ctx, "DELETE", url, nil, nil, nil, &taskResponse)
	}
	if err != nil {
		return
	}
...
func (c *Client) SetLxcConfig(ctx context.Context, vmr *VmRef, vmParams map[string]interface{}) (exitStatus interface{}, err error) {
	...
	resp, _, err := c.session.put(ctx, url, nil, nil, &reqbody)
	if err == nil {
		taskResponse, err := responseJSON(resp)
		if err != nil {
			return nil, err
...
func (c *Client) Unlink(ctx context.Context, node string, ID GuestID, diskIds string, forceRemoval bool) (exitStatus string, err error) {
	...
	resp, _, err := c.session.put(ctx, url, nil, nil, &data)
	if err != nil {
...
func (c *Client) GetNextID(ctx context.Context, startID *GuestID) (GuestID, error) {
	...
	if startID != nil {
		...
		return c.getNextIDstart_Unsafe(ctx, *startID)
	}
...
func (c *Client) getNextIDstart_Unsafe(ctx context.Context, guestID GuestID) (GuestID, error) {
	...
	var err error
	for {
		tmpID, err = c.GetItemConfigString(ctx, url_NextID+"?vmid="+guestID.String(), "API", "cluster/nextid")
		if err == nil {
			break
		}
		var apiErr *ApiError
...
func (c *Client) DeleteVMDisks(
	...
	for _, fullDiskName := range disks {
		...
		_, _, err := c.session.post(ctx, url, nil, nil, nil)
		if err != nil {
			return err
		}
	}
...
func (c *Client) QemuAgentFileWrite(ctx context.Context, vmr *VmRef, params map[string]interface{}) (err error) {
	...
	_, _, err = c.session.post(ctx, url, nil, nil, &reqbody)
	return
}
...
func (c *Client) DeleteQemuIPSetNetwork(ctx context.Context, vmr *VmRef, IPSetName string, network string, params map[string]interface{}) (exitStatus interface{}, err error) {
	...
	resp, _, err := c.session.delete(ctx, url, &values, nil)
	if err == nil {
		taskResponse, err := responseJSON(resp)
		if err != nil {
			return nil, err
...
func (c *Client) UpdateVMHA(ctx context.Context, vmr *VmRef, haState string, haGroup string) (exitStatus interface{}, err error) {
	...
	if vmr.haState == "" {
		...
		reqbody := paramsToBody(paramMap)
		resp, _, err := c.session.post(ctx, "/cluster/ha/resources", nil, nil, &reqbody)
		if err == nil {
			taskResponse, err := responseJSON(resp)
			if err != nil {
				return nil, err
...
// Shared
func (c *Client) GetItemConfigMapStringInterface(ctx context.Context, url, text, message string) (map[string]any, error) {
...
func (c *Client) GetItemConfig(ctx context.Context, url, text, message string) (config map[string]any, err error) {
...
// Reads all the rules from a node
func (c *Client) ReadNodeFirewallRules(ctx context.Context, node string) ([]interface{}, error) {
	if c == nil {
		return nil, errors.New(Client_Error_Nil)
	}
	rules, err := c.GetItemConfigInterfaceArray(ctx,
...
// Reads a single rule from a node
func (c *Client) ReadNodeFirewallRule(ctx context.Context, node string, pos int) (map[string]interface{}, error) {
	if c == nil {
		return nil, errors.New(Client_Error_Nil)
	}
...
// Creates a firewall rule on a node
func (c *Client) CreateNodeFirewallRule(ctx context.Context, node string, params map[string]interface{}) error {
	if c == nil {
		return errors.New(Client_Error_Nil)
	}
	err := c.Post(ctx, params, fmt.Sprintf("/nodes/%s/firewall/rules", node))
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) DeleteNodeFirewallRule(ctx context.Context, node string, pos int) error {
	...
	err := c.Delete(ctx, fmt.Sprintf("/nodes/%s/firewall/rules/%d", node, pos))
	if err != nil {
		return err
	}
	return nil
